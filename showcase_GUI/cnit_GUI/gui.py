...
class Demo_LORA_Traffic_Generator:
    def __init__(self, top=None):
        ...
        self.TFrame1.place(relx=0.0, rely=0.11, relheight=0.9, relwidth=0.99)
        ...
        self.RadiobuttonTdmaOff.place(relx=0.36, rely=0.45, relheight=0.08
                , relwidth=0.26)
        ...
        self.RadiobuttonTdmaOn.place(relx=0.68, rely=0.45, relheight=0.08
                , relwidth=0.26)
